"""
File: airflow-log-cleanup.py
Author: https://github.com/teamclairvoyant
Url: https://github.com/teamclairvoyant/airflow-maintenance-dags/tree/master/log-cleanup
License: https://github.com/teamclairvoyant/airflow-maintenance-dags/blob/master/LICENSE
